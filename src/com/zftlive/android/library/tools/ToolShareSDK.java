...
import com.zftlive.android.library.common.onekeyshare.OnekeyShare;
...
public class ToolShareSDK {
	 ...
	 * @param mContext 上下文
	 */
	public ToolShareSDK init(Context mContext){
	 ...
	 * @param platform 分享平台
	 */
	public Platform initPlatform(String type){
		Platform platForm = null;
		if(SinaWeibo.NAME.equals(type)){
			platForm = ShareSDK.getPlatform(mContext, SinaWeibo.NAME);
		}else if(TencentWeibo.NAME.equals(type)){
			platForm = ShareSDK.getPlatform(mContext, TencentWeibo.NAME);
		...
		}else if(WechatMoments.NAME.equals(type)){
			//分享给朋友圈
			HashMap<String, Object> map = new HashMap<String, Object>();
			map.put("BypassApproval", false);
			ShareSDK.setPlatformDevInfo("Wechat", map);
		...
		}else if(WechatFavorite.NAME.equals(type)){
			//分享给朋友圈
			HashMap<String, Object> map = new HashMap<String, Object>();
			map.put("BypassApproval", false);
			ShareSDK.setPlatformDevInfo("Wechat", map);
			ShareSDK.setPlatformDevInfo("WechatMoments", map);
			platForm = ShareSDK.getPlatform(mContext, WechatFavorite.NAME);
		}else if(QQ.NAME.equals(type)){
			platForm = ShareSDK.getPlatform(mContext, QQ.NAME);
		}else if(QZone.NAME.equals(type)){
			platForm = ShareSDK.getPlatform(mContext, QZone.NAME);
		}else if(Email.NAME.equals(type)){
			platForm = ShareSDK.getPlatform(mContext, Email.NAME);
		}else if(ShortMessage.NAME.equals(type)){
			platForm = ShareSDK.getPlatform(mContext, ShortMessage.NAME);
		}else{
			platForm = ShareSDK.getPlatform(mContext, type);
		}
