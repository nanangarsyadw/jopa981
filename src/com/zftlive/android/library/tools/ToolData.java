...
public class ToolData {
   ...
   * @param formData 表单数据
   */
  public static void fillBackForm(ViewGroup formRoot, DTO<String, Object> formData) {
    if (null == formRoot || null == formData || formData.isEmpty()) return;

    if (formRoot.getChildCount() > 0) {
      for (int i = 0; i < formRoot.getChildCount(); i++) {
        View view = formRoot.getChildAt(i);
        ToolLog.d(TAG, "当前控件：" + view.getClass().getName() + "." + view.getTag());
        // 容器级别控件需要进行递归
        if (view instanceof LinearLayout) {
          ...
          fillBackForm((com.zftlive.android.library.widget.RadioGroup) view, formData);
         ...
         */
          ...
          if (((android.widget.RadioButton) view).getText().toString()
            ...
            .equals(com.zftlive.android.library.widget.RadioButton.class.getName())) {
          com.zftlive.android.library.widget.RadioButton mView =
              (com.zftlive.android.library.widget.RadioButton) view;
         ...
         */
          ...
          if (strFormValue.indexOf(mView.getText().toString()) != -1) {
            ...
            .equals(com.zftlive.android.library.widget.CheckBox.class.getName())) {
          com.zftlive.android.library.widget.CheckBox mView =
              (com.zftlive.android.library.widget.CheckBox) view;
         ...
         */
          ...
          for (int j = 0; j < mItemCount; j++) {
            ...
            .equals(com.zftlive.android.library.widget.SingleSpinner.class.getName())) {
          com.zftlive.android.library.widget.SingleSpinner mView =
              (com.zftlive.android.library.widget.SingleSpinner) view;
          int mItemCount = mView.getAdapter().getCount();
          for (int j = 0; j < mItemCount; j++) {
   ...
   */
  public static DTO<String, Object> gainForm(ViewGroup root, DTO<String, Object> formData) {
    if (root.getChildCount() > 0) {
      for (int i = 0; i < root.getChildCount(); i++) {
        ...
        if (view instanceof LinearLayout) {
          ...
          gainForm((com.zftlive.android.library.widget.RadioGroup) view, formData);
        } else if (view instanceof TableLayout) {
