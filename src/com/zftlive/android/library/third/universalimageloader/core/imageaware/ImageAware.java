 ...
 *******************************************************************************/
package com.zftlive.android.library.third.universalimageloader.core.imageaware;
 ...
 * through {@link com.zftlive.android.library.third.universalimageloader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link android.view.View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link com.zftlive.android.library.third.universalimageloader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
	...
	/**
	 * Returns {@linkplain com.zftlive.android.library.third.universalimageloader.core.assist.ViewScaleType scale type} which is used for
	 ...
	 * {@link com.zftlive.android.library.third.universalimageloader.core.listener.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain com.zftlive.android.library.third.universalimageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *android.graphics.drawable.Drawable) for empty Uri},
	 * {@linkplain com.zftlive.android.library.third.universalimageloader.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *android.graphics.drawable.Drawable) on loading} or
	 * {@linkplain com.zftlive.android.library.third.universalimageloader.core.DisplayImageOptions.Builder#showImageOnFail(
	 *android.graphics.drawable.Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain com.zftlive.android.library.third.universalimageloader.core.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link com.zftlive.android.library.third.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 ...
	 * {@link com.zftlive.android.library.third.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
