...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain com.zftlive.android.library.third.universalimageloader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
