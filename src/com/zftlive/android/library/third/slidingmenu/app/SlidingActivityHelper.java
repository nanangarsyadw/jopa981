package com.zftlive.android.library.third.slidingmenu.app;
...
import com.zftlive.android.library.third.slidingmenu.SlidingMenu;
...
public class SlidingActivityHelper {
	...
	public void onCreate(Bundle savedInstanceState) {
		mSlidingMenu = (SlidingMenu) LayoutInflater.from(mActivity).inflate(R.layout.view_slidingmenu_main, null);
	}
