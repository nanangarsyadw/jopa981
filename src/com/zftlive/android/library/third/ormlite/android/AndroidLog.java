 ...
 * @author graywatson
 */
public class AndroidLog implements com.zftlive.android.library.third.ormlite.logger.Log {
	...
	public AndroidLog(String className) {
		...
		int maxLevel = 0;
		for (com.zftlive.android.library.third.ormlite.logger.Log.Level level : com.zftlive.android.library.third.ormlite.logger.Log.Level.values()) {
	...
	private int levelToAndroidLevel(com.zftlive.android.library.third.ormlite.logger.Log.Level level) {
		switch (level) {
			case TRACE :
				return Log.VERBOSE;
			case DEBUG :
