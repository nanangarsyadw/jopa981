...
public class NumberProgressBar extends View {
  ...
  public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    final TypedArray attributes =
        context.getTheme().obtainStyledAttributes(attrs, R.styleable.NumberProgressBar,
            defStyleAttr, 0);
    mDisplayLabel = attributes.getString(R.styleable.NumberProgressBar_progress_label);
    mReachedBarColor =
        attributes.getColor(R.styleable.NumberProgressBar_progress_reached_color,
            default_reached_color);
    mUnreachedBarColor =
        attributes.getColor(R.styleable.NumberProgressBar_progress_unreached_color,
            default_unreached_color);
    mTextColor =
        attributes.getColor(R.styleable.NumberProgressBar_progress_text_color, default_text_color);
    mTextBgColor =
        attributes.getColor(R.styleable.NumberProgressBar_progress_text_background_color,
            default_text_color);
    mTextBgStrokeColor =
        attributes.getColor(R.styleable.NumberProgressBar_progress_text_stroke_color,
            default_text_color);
    mTextBgStrokeWidth =
        attributes.getDimension(R.styleable.NumberProgressBar_progress_text_stroke_width,
            mTextBgStrokeWidth);
    mTextBgRadiusSize =
        attributes.getDimension(R.styleable.NumberProgressBar_progress_text_background_radius,
            mTextBgRadiusSize);
    mTextSize =
        attributes
            .getDimension(R.styleable.NumberProgressBar_progress_text_size, default_text_size);
    mReachedBarHeight =
        attributes.getDimension(R.styleable.NumberProgressBar_progress_reached_bar_height,
            default_reached_bar_height);
    mUnreachedBarHeight =
        attributes.getDimension(R.styleable.NumberProgressBar_progress_unreached_bar_height,
            default_unreached_bar_height);
    mOffset =
        attributes.getDimension(R.styleable.NumberProgressBar_progress_text_offset,
            default_progress_text_offset);
    int textVisible = attributes.getInt(R.styleable.NumberProgressBar_progress_text_visibility, 0);
    if (textVisible != 0) {
      mIfDrawText = false;
    }
    mCurrentProgress = attributes.getInt(R.styleable.NumberProgressBar_progress_current, 0);
    mMaxProgress = attributes.getInt(R.styleable.NumberProgressBar_progress_max, 100);
    attributes.recycle();
