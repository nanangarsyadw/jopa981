...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabTextColor = 0x7fffffff;
	private int tabSelectedTextColor = Color.WHITE;
	...
	public void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				int selectedColor = this.tabSelectedTextColor != Color.WHITE?this.tabSelectedTextColor:Color.WHITE;
				tab.setTextColor(i == selectedPosition ? selectedColor : tabTextColor);
...
//		}
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
			...
			Log.i("PagerSlidingTabStrip", "position=" + position + "|positionOffset=" + positionOffset + "|positionOffsetPixels=" + positionOffsetPixels);
		}
		...
		public void onPageSelected(int position) {
			...
			for (int i = 0; i < tabCount; i++) {
				...
				if(tab instanceof TextView) {
					//增加对选中颜色的设置
					int selectedColor = tabSelectedTextColor != Color.WHITE?tabSelectedTextColor:Color.WHITE;
					((TextView) tab).setTextColor(i == position ? selectedColor : tabTextColor);
				}
			}
		}
